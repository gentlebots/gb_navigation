...
def generate_launch_description():
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(gb_nav_dir, 'params', 'nav2_tiago_params.yaml'),
    ...
    bringup_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(gb_nav_launch_dir, 'nav2_bringup_launch.py')),
    ...
    plansys2_cmd = IncludeLaunchDescription(
        ...
        launch_arguments={'model_file': gb_nav_dir + '/pddl/domain.pddl'}.items()
        )
